...
import org.parse4j.bolts.Continuation;
import org.parse4j.bolts.Task;
...
//  }
  ...
  public static ParseConfig get() throws ParseException {
	  ParseGetCommand command = new ParseGetCommand("config", null);
		...
		if(!response.isFailed()) {
			...
			ParseConfig config = decode(jsonResponse, new ParseDecoder());
  ...
  /* package */ Map<String, Object> getParams() {
    return Collections.unmodifiableMap(new HashMap<String, Object>(params));
  }
